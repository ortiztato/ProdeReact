...
const Goleadores = () => {
  ...
  if (Goleadores.length < 3) {
    ...
    titulogoleadores = "resultadocampeongol";
  } else {
    titulogoleadores = "resultadoerrorgol";
  }
  ...
  if (PrecioTotal > 100) {
    ...
    presupuesto = "presupuestook";
  }

  return (
    <section className="sectiongoleadores">
      <div className="subtituloequipos">
        Goleadores
        <span
          className={titulogoleadores}
          style={{
            display:
              (full && PrecioTotal <= 100) || Goleadores.length === 0
                ? "none"
                : "",
          }}
        >
        ...
        {Goleadores.length > 0 && (
          <span className="editar" onClick={editarSemis}>
            limpiar
          </span>
        )}
      </div>
      ...
      <div>
        <div id="reglascampeon" className="reglas">
          Tenes <strong>$ 100 </strong> para elegir{" "}
          <strong>3 goleadores</strong> <br />
          Los goleadores entregan <strong>1 punto</strong> por cada gol que
          meten
          <br />
      ...
      <div>
        ...
        <div className={presupuesto}>
          Presupuesto Restante: ${100 - PrecioTotal}
        </div>
      </div>
    </section>
  );
